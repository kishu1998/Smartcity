          ...
          <div class="inner">
					...
					<div class="col-lg-1"></div>
                        <div class="col-lg-12">
                                    ...
                                    <form action="deletecom.php" method="POST" class="form-horizontal" id="block-validate" enctype="multipart/form-data">
                                 ...
                                 <input type="text"  id="required2" name="cp_name" value="<?php echo($row['ur_location']);?>"class="form-control" disabled/>
                                                ...
                                                <label class="control-label ">FEEDBACK satisfied????</label>
                                                <div >
